...
public class CommandStack {
    ...
    /**
     * craetes a new stack with a stack of commands to go forward and one to go
     * backwards
     */
    public CommandStack() {
        backwards = new Stack<>();
    ...
    /**
     * goes back poping the top of the backwards stack, calling revoke and
     * putting it on the forward stack.
     *
     * @throws SQLException
     */
    ...
    /**
     * goes forward poping the top of the forwards stack, execute it and put it
     * on the top of the backwards stack.
     *
     * @throws SQLException
     */
