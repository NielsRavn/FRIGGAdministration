/*
 * Êîìïîíåíò: ðàñêðûâàþùèéñÿ ðåäàêòîð.
 *
 * Created on 13 Îêòÿáðü 2006 ã., 13:37
 *
 */
...
/**
 * this class was taken from the date choser to change like one line... Bean
 * "Combo date editor". <br>
 * Êîìïîíåíò: "Ðàñêðûâàþèéñÿ ðåäàêòîð äàòû"
 *
 * @author Androsov Vadim
 * @since 1.0
 */
public class MyDateChooserCombo extends DateChooserVisual {

    public static final long serialVersionUID = -7510689410235869108L;

    /**
     * Combo property's name prefix.<br>
     * Ïðèñòàâêà ê íàçâàíèÿì âñåõ ñâîéòñâ ðàñêðûâàþùåãîñÿ ðåäàêòîðà.
     *
     * @since 1.0
     */
...
//        bShowPopup.setBorderPainted(false);
    ...
    private MyDateChooserCombo getComboPanel() {
        return this;
    }
     ...
     * Âîçâðàùàåò âûáðàííóþ äàòó â âèäå ñòðîêè â çàäàííîì ôîðìàòå.
     *
     * @see DateChooserCombo#getFormat()
     * @return Selected date(s) in text format.<br>
     * Âûáðàííûå äàòû â òåêñòîâîì ôîðìàòå.
     */
    ...
    /**
     * Sets date from string, uses current format. Works only for single
     * selection null null null     behavior<br><br><CODE>
     *        dateChooserCombo.setBehavior(MultyModelBehavior.SELECT_SINGLE);<br>
     * dateChooserCombo.setText("");
     * </CODE><br><br>
     * Óñòàíàâëèâàåò äàòó ïî ñòðîêîâîìó ïðåäñòàâëåíèþ. Ó÷èòûâàåòñÿ óñòàíîâëåííûé
     * ôîðìàò. Ðàáîòàåò òîëüêî äëÿ åäèíè÷íîãî âûáîðà.
     *
     * @param text Text to set. Null or empty string selects empty date.<br>
     * Òåêñò ñ äàòîé. Null èëè ïóñòàÿ ñòðîêà ïîçâîëÿþò ñäåëàòü ïóñòîé âûáîð (íå
     * âûáðàòü íè îäíîé äàòû)
     * @return True if date was successfully set.<br>
     * Èñòèíà åñëè çíà÷åíèå äàòû áûëî óñïåøíî óñòàíîâëåíî.
     * @see DateChooserCombo#getFormat()
    ...
    /**
     * Date field font.<br>
     * Øðèôò ïîëÿ, â êîòîðîì âûâîäèòñÿ äàòà.
     *
     * @since 1.0
     */
    ...
    public void setCurrentNavigateIndex(int currentNavigateIndex) {
        if (currentNavigateIndex != 1) {
            //äëÿ äðóãîé ïàíåëè âîçíèêàþò ïðîáëåìû ïðè âûáîðå ìåñÿöà -
            //ìåíþ çàêðûâàåòñÿ :(
            return;
        }
     ...
     * Ýêñïåðèìåíòàëüíàÿ ôóíêöèÿ. Åñëè óñòàíîâëåíî íå null - íàñòðîéêà ñ ïîìîùüþ
     * ìåòîäà setFormat (à çíà÷èò è âñå âèçóàëüíûå íàñòðîéêè ýòîãî ñâîéñòâà)
     * áóäóò èãíîðèðîâàòüñÿ. Â ñëåäóþùèõ âåðñèÿõ ïîëèòèêà âûáîðà ôîðìàòà áóäåò
     * áîëåå îñíîâàòåëüíî ïðîäóìàíà.
     *
     * @since 1.1
     */
    ...
    /**
     * Set date format. If you set not null setFormat will be ignored. To turn
     * on setFormat (and visual format property customization) call
     * <b>setDateFormat(null)</b>. EXPERIMENTAL!<br>
     * Ýêñïåðèìåíòàëüíàÿ ôóíêöèÿ. Ïîçâîëÿåò óñòàíîâèòü ôîðìàò âûâîäà è ââîäà
     * äàòû. Åñëè óñòàíîâëåíî íå null - íàñòðîéêà ñ ïîìîùüþ ìåòîäà setFormat (à
     * çíà÷èò è âñå âèçóàëüíûå íàñòðîéêè ýòîãî ñâîéñòâà) áóäóò èãíîðèðîâàòüñÿ.
     * Óñòàíîâèòå null ÷òîáû ìåòîä setFormat çàðàáîòàë ïî-ñòàðîìó.
     *
     * @since 1.1
     */
