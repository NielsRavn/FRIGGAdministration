...
public class TabView extends JTabbedPane {
    ...
    /**
     * adds a tab to the tabview, and gives the content a lowered bevelborder to
     * show that it is in the tab.
     *
     * @param tabName the name to stand on the tab
     * @param content the content that should be shown under the tab
     * @param width the width of the screen to calculate tab size and make them
     * clickable with touch
     */
     ...
     * @param state the state to set the tab in, false for not being able to
     * pick the tab.
     */
